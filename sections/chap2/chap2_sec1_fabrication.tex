...
\begin{document}
	...
	We seldom used this technique to produce graphene devices, due to issues in creating such large area coverage with liquid metal oxide synthesis (refer to \cref{chap:thinoxides}). Another issue is the lack of geometric definition, however this can be found, as described in \cref{sec:findinggeometricfactor}. %TODO make oxide reference more specific?
...
%			\subcaption{after 10s ultrasonication}		
	...
	\begin{wrapfigure}[10]{r}[0pt]{7.5cm}
		\vspace{-0.5cm}
		\centering
		\includegraphics[width=0.35\textwidth]{chap2/S09_100x}
	...
	\begin{wrapfigure}[9]{r}[0pt]{7cm}
		\vspace{-1.1cm}
		\centering
		\includegraphics[width=0.45\textwidth]{chap2/annealing1}
	...
	\begin{figure}[H]
%	\begin{wrapfigure}[9]{r}[0pt]{5cm}
%		\vspace{-1.1cm}
		\centering
		\begin{subfigure}{0.45\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{chap2/pcb_footprint}
			\caption{CAD Footprint}
		\end{subfigure}
		\begin{subfigure}{0.45\textwidth}
			\centering
			\includegraphics[width=0.4\textwidth]{chap2/pcb_image}
